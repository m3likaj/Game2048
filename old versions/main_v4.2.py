...
# this is V3 with expectimax

metrics_file = "training_metrics_v4.2.csv"
...
def train_ddqn(agent, episodes=500, update_target_every=10):
    ...
    for episode in range(1, episodes + 1):
        ...
        if episode % 200 == 0:
            agent.main_model.save(f"ddqn_model_v4.2_{episode}.h5")
...
if __name__ == '__main__':
    ...
    trained_agent.main_model.save("trained_ddqn_model_v4.2.h5")
