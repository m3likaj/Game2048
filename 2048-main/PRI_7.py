...
metrics_file = "training_metrics_7.csv"
...
def train_agent(board_size, memory_size, batch_size, episodes, max_steps):
    ...
    for episode in range(1, episodes + 1):
        ...
        if episode % 100 == 0:
            agent.q_network.model.save(f"ddqn_model_7_{episode}.keras")
...
if __name__ == "__main__":
    ...
    trained_agent.q_network.model.save("trained_ddqn_model_7.keras")
