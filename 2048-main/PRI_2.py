...
if not os.path.exists(metrics_file):
    with open(metrics_file, mode="w", newline="") as file:
        ...
        writer.writerow(["Episode", "Score", "Invalid Moves", "Highest Tile", "Total Reward"])

def log_metrics(episode, score, invalid_moves, highest_tile, total_reward):
    with open(metrics_file, mode="a", newline="") as file:
        writer = csv.writer(file)
        writer.writerow([episode, score, invalid_moves, highest_tile, total_reward])
...
def train_agent(board_size, memory_size, batch_size, episodes, max_steps):
    ...
    for episode in range(1, episodes + 1):
        ...
        log_metrics(episode, board.score, invalid_moves, highest_tile, total_reward)
        ...
        if episode % 100 == 0:
            agent.q_network.model.save(f"ddqn_model_{episode}.h5")
...
if __name__ == "__main__":
    ...
    trained_agent.q_network.model.save("trained_ddqn_model_2.h5")
