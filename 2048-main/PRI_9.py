...
#attempting to use expectimax while training

# Directions for 2048
LEFT, UP, RIGHT, DOWN = (0, -1), (-1, 0), (0, 1), (1, 0)
directions = [LEFT, UP, RIGHT, DOWN]

metrics_file = "training_metrics_9.csv"
...
def train_agent(board_size, memory_size, batch_size, episodes, max_steps):
    ...
    for episode in range(1, episodes + 1):
        ...
        for step in range(max_steps):
            if episode % 10 == 0:
                direction = getNextBestMoveExpectiminimax(board, pool, 2)
            else:
        ...
        if episode % 200 == 0:
            agent.q_network.model.save(f"ddqn_model_9_{episode}.h5")
...
if __name__ == "__main__":
    ...
    trained_agent.q_network.model.save("trained_ddqn_9_model.h5")
