...
def gameLoop():
    ...
    while 1:
        ...
        if ai and not board.checkLoss():
            nextBestMove = getNextBestMoveExpectiminimax(board, pool, agent, depth)
...
if __name__ == '__main__':
    ...
    # If you have an Agent class with a QNetwork named 'q_network':
    global agent
    agent = Agent(state_size, action_size, memory_size, batch_size)  # same parameters as in training
    agent.q_network.model.load_weights("trained_ddqn_5_model.h5")
