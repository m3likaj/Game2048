...
#version 7 with expectimax



metrics_file = "training_metrics_PRI8.csv"
...
def train_agent(agent, episodes, max_steps):
    ...
    for e in range(1, episodes+1):
        ...
        if e % 200 == 0:
            agent.q_network.model.save(f"ddqn_model_PRI8_{e}.h5")
...
'''if __name__ == '__main__':
    ...
    agent.q_network.model.save("trained_ddqn_model_PRI8.h5")'''
